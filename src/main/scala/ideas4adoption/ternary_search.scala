...
object ternary_search extends App {
  class TS(s: List[Int]) {
    ...
    def search_aux(segmentX: (Int, Int), segmentY: (Int, Int), i: Int, depth: Int): (List[List[Int]],Int) = {
      ...
      if (segmentX._1 == segmentX._2 && segmentY._1 == segmentY._2)
        if (segmentX._1 != segmentY._1 && i == bs(segmentX._1) + bs(segmentY._1)) {
          ...
          (List(List(segmentX._1, segmentY._1)),1)
        } else (Nil,1)
      else {
        ...
        if (tooSmall || tooLarge) (Nil,1)
          ...
          val r = wholeSplit.toList.map(s => search_aux(s._1, s._2, i, depth + 1)).foldLeft((List[List[Int]](), 1)) {
